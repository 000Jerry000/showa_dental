        ...
        <div id="mv">
            ...
            <ul class="mv__list">
                <li>
                    ...
                    <span class="middle under-marker-green">徒歩<span class="num">4</span>分</span>
                </li>
                <li>
            ...
            <div class="inner base__flex">
                <div class="base__flex-item js-fadeUp">
                    ...
                    <p>当院ではワイヤー矯正とマウスピース矯正のインビザラインを導入しております。<br>
                        ...
                        成人35,000円<small>（税込）</small>×18回<small>（分割手数料なし）</small></span><br>
                        上記のリーズナブルな月々分割支払いでも提供可能です。
                    </p>
                    <a href="<?= home_url('/ortho/') ?>" class="base__link center">詳しく見る</a>
                </div>
